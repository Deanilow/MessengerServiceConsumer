...
const bot_name = "51900262844"

const adapterProvider51900262844 = createProvider(BaileysProvider, {
    name: bot_name
})

// const adapterProvider = createProvider(BaileysProvider)

const main51900262844 = async () => {
    const adapterDB = new MockAdapter()
    const adapterFlow = createFlow([flowPrincipal])

    createBot({
        flow: adapterFlow,
        provider: adapterProvider51900262844,
        database: adapterDB,
    })

    // QRPortalWeb()
    QRPortalWeb({ name: bot_name, port: process.env.PORT_BOT1 })
}

module.exports = {
    main51900262844,
    adapterProvider51900262844  // Exporta adapterProvider
};
